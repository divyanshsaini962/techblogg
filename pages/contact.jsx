...
const Contact = () => {
  return (
    ...
    <Head>
      ...
      <meta name="description" content="Get in touch with the Tech Blog Service team. Send us your tech questions 
      and feedback. tech blog , tech all in one product, Contact us here for content suggestions, advertising inquiries, or to connect"/>
      <meta name="keywords" content="contact, contact us, get in touch, connect, tech blog, email, phone number,
       address, location, suggestions, feedback, inquiries, advertising, collaboration"/>
          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 className="mb-6 ml-8 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-base ml-8 leading-relaxed mb-9 text-body-color">
                The goal is to make the title clearly indicate that this is the contact page for
                 "Tech Blog Service", while also using action-oriented language to encourage users 
                 to get in touch. You can be creative with the descriptive subtitle to communicate 
                 your brand voice.
                </p>
                <div className="mb-8 ml-4 flex w-full max-w-[370px]">
                  <div className="mr-6 ml-4 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width={24}
                      height={24}
                      viewBox="0 0 24 24"
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 ml-4 text-xl font-bold text-dark">
                      Our Location
                    </h4>
                    <p className="text-base ml-4 text-body-color">
                      Jhansi Uttar Predesh <br />
                      India 
                    </p>
                  </div>
                </div>
